...
2. **Destroying process.** We also have access to a procedure that can gradually destroy the information in data samples. This procedure **may** involve randomness. Like the training dataset, this procedure is fully specified *a priori*, before any training takes place.
